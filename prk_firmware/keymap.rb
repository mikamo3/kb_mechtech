...
kbd.add_layer :raise, %i(
  KC_GRV  KC_EXLM KC_AT   KC_HASH KC_DLR  KC_PERC KC_CIRC KC_AMPR KC_ASTER KC_LPRN KC_RPRN KC_DEL
  CT_TAB  KC_1    KC_2    KC_3    KC_4    KC_5    KC_6    KC_7    KC_8    KC_9    KC_0    KC_QUOT
  KC_LSFT KC_EQL  KC_LABK  KC_LCBR KC_LBRC KC_MINS KC_RBRC KC_RCBR KC_RABK   KC_SLSH KC_BSLS KC_NO
  KC_LCTL KC_LALT KC_LGUI RAISE   KC_NO   KC_NO   LOWER   KC_NO   KC_RGUI KC_RALT KC_RCTL KC_NO
)
